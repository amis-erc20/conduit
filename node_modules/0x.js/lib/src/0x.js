...
var ZeroEx = /** @class */ (function () {
    ...
    function ZeroEx(provider, config) {
        ...
        this._web3Wrapper = new web3_wrapper_1.Web3Wrapper(provider, config.networkId, defaults);
        this.proxy = new token_transfer_proxy_wrapper_1.TokenTransferProxyWrapper(this._web3Wrapper, config.tokenTransferProxyContractAddress);
        this.token = new token_wrapper_1.TokenWrapper(this._web3Wrapper, this._abiDecoder, this.proxy);
        this.exchange = new exchange_wrapper_1.ExchangeWrapper(this._web3Wrapper, this._abiDecoder, this.token, config.exchangeContractAddress);
        this.tokenRegistry = new token_registry_wrapper_1.TokenRegistryWrapper(this._web3Wrapper, config.tokenRegistryContractAddress);
        this.etherToken = new ether_token_wrapper_1.EtherTokenWrapper(this._web3Wrapper, this.token, config.etherTokenContractAddress);
