...
var EtherTokenWrapper = /** @class */ (function (_super) {
     ...
     */
    EtherTokenWrapper.prototype.depositAsync = function (amountInWei, depositor, txOpts) {
     ...
     * @return Transaction hash.
     */
    EtherTokenWrapper.prototype.withdrawAsync = function (amountInWei, withdrawer, txOpts) {
        if (txOpts === void 0) { txOpts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        wethContractAddress = this.getContractAddress();
     ...
     */
    EtherTokenWrapper.prototype.getContractAddress = function () {
        var contractAddress = this._getContractAddress(artifacts_1.artifacts.EtherTokenArtifact, this._contractAddressIfExists);
